...
import com.company.threadingdemo.dal.OrderdetailDAO;
...
public class Orderdetail implements java.io.Serializable {
	...
	public Orderdetail(OrderdetailId id, Order order, Product product, BigDecimal unitprice, short quantity,
			float discount) {
		this.id = id;
		this.order = order;
